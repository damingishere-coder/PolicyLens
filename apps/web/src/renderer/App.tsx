...
interface ResearchRunView {
  id: string;
  status: string;
  summary: { discovered_products?: number; waiting_review?: number; rejected_products?: number; lead_only?: number };
...
function ResearchStatus({ status }: { status: string }) {
  ...
  const labels: Record<string, string> = { FAILED: "执行失败", CANCELLED: "已取消", INTERRUPTED: "已中断", NO_RESULT: "未发现结果", SEARCHING: "研究中" };
